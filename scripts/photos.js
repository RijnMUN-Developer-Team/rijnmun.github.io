...
for (let day=1; day<=num_photos.length; day++) {
    ...
    for (let i=1; i<=num_photos[day-1]; i++) {
        day_photos_div.innerHTML += `<img loading="lazy" class="conference-photos" src="/images/conference-photos/day${day}/img1${("0"+i).slice(-2)}.JPG" alt="Day ${day} Image ${i}">`;
    }
}